...
PIR detects motion	Adjustable delays via potentiometer	Multi-gate synchronization	Mobile app control
Gate opens/closes autonomously	Logged event data	Remote monitoring	Cloud integration
Ultrasonic safety check (<20cm)	Diagnostic serial output	Thermal imaging	Voice commands
Potentiometer tuning mode	LED/OLED status displays	Email alerts	AI scheduling
Buzzer alerts on safety halt	Smooth servo ramp limits	Sound threshold tuning	
